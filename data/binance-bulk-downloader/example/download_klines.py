...
downloader = BinanceBulkDownloader(data_frequency="5m",start_date="2024-11")
downloader.run_download()

# download klines (frequency: "1d", asset="um")
downloader = BinanceBulkDownloader(data_frequency="1d",start_date="2024-11")
downloader.run_download()

# download monthly klines (frequency: "1m", asset="um", timeperiod_per_file="monthly")
downloader = BinanceBulkDownloader(data_frequency="1m", timeperiod_per_file="monthly",start_date="2024-11")
downloader.run_download()

# download klines (frequency: "1m", asset="cm")
downloader = BinanceBulkDownloader(data_frequency="1m", asset="cm",start_date="2024-11")
downloader.run_download()
